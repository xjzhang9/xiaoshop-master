package com.xjzhang.xiaoshop.cart.controller;

import com.xjzhang.base.wrapper.BaseWrapper;
import com.xjzhang.xiaoshop.cart.model.dto.CheckCartDTO;
...
public class CartController {
    ...
    BaseWrapper checkCart(@RequestParam("skuId") Long skuId, @RequestParam("isChecked")  Integer isChecked) {
    ...
    BaseWrapper changeItemCount(@RequestParam("skuId") Long skuId, @RequestParam("num")  Integer num) {
    ...
    BaseWrapper deleteItem(@RequestBody List<Long> skuIds) {
